...
export default function UserOverview() {
  ...
  return (
    <section className="flex flex-col lg:flex-row px-5 sm:px-8 md:px-16 lg:px-28 mb-28 mt-28 lg:mb-[200px] lg:mt-[200px] gap-8 md:gap-12 lg:gap-20 ">
      <div className="w-full lg:w-1/3 flex flex-ms-col items-center  justify-start mb-8 lg:mb-0 ">
      ...
      <div className="w-full lg:w-2/3 flex justify-center lg:justify-end items-center order-1 lg:order-2 lg:min-h-[750px]">
        <img
