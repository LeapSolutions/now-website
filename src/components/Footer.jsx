      ...
      <div className="w-full px-7  grid grid-cols-1 md:grid-cols-4 gap-14  ">
        <div>
          ...
          <p className="text-sm max-w-sm leading-relaxed text-gray-300">
            NOW er et dansk system til tidsregistrering og ressourceplanlægning
            – udviklet til virksomheder, der har brug for et brugervenligt
            værktøj i hverdagen
          </p>
        </div>

        <div>
          <h3 className="font-semibold text-lg mb-4 font-secondary">
            Hurtig navigation
          </h3>
          <ul className="space-y-2 text-md text-white font-secondary">
            <li>
              <a href="#funktionsOversigt" className="hover:text-gray-200">
                Funktioner
              </a>
            </li>
            <li>
              <a href="#priser" className="hover:text-gray-200">
                Priser
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-md">
            <li className="flex items-center gap-2 text-white hover:text-gray-200 font-secondary ">
              ...
              <a href="tel: +4593605884">+45 9360 5884</a>
            </li>
            <li className="flex items-center gap-2 text-white hover:text-gray-200 font-secondary">
              <FaEnvelope className="text-white" />
              <a href="mailto:info@gonow.dk"> info@gonow.dk</a>
            </li>
