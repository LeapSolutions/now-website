...
const features = [
  ...
  },
  {
    icon: "allowance.svg",
    heading: "Diæter",
    description: "NOW giver mulighed for at registrere og beregne diæter pr. projekt eller bruger. Systemet understøtter faste satser og beløbsgrænser for medarbejdere.",
    image: "src/assets/images/features/allowanceFeature.png",
  },
  {
    icon: "absence.svg",
    heading: "Fravær og ferie",
    description: "NOW gør det nemt at holde styr på medarbejderes ferie og sygdom. Længere fraværsperioder kan registreres med få klik direkte i kalenderen.",
    image: "src/assets/images/features/absenceFeature.png",
  },
  {
    icon: "report.svg",
    heading: "Rapportering",
    description: "NOW samler arbejdstimer, projektudgifter og opgavefremskridt i klare rapporter. Det giver ledelsen det nødvendige overblik til at evaluere ressourceforbrug og planlægning.",
          ...
          <div className="grid grid-cols-3 grid-rows-2 gap-4 md:gap-6 mb-6 md:mb-8 w-full justify-items-center lg:justify-items-start">
            {features.map((f, idx) => (
              ...
              >
                <span>
                  {iconMap[f.icon] ? (
                    <img src={iconMap[f.icon]} alt={f.heading} className="w-8 h-8 md:w-12 md:h-12" />
                  ) : (
