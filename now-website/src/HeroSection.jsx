  ...
  <section className="relative w-full h-[80vh] flex items-center overflow-hidden">
    ...
    <div className="relative z-20 text-white max-w-xl ml-10">
      ...
      <div className="flex gap-4">
        <button className="bg-orange-400 hover:bg-orange-500 text-white px-6 py-3 rounded font-semibold transition">
          Prøv nu
        </button>
        <button className="border border-white text-white px-6 py-3 rounded font-semibold hover:bg-white hover:text-orange-500 transition">
          Kontakt os
        </button>
      </div>
    </div>
