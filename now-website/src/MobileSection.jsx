...
const MobileSection = () => (
  <section className="relative w-full bg-[#034C8C] min-h-[100vh] lg:min-h-[340px] mt-32 px-6 sm:px-8 md:px-16 lg:px-28 flex items-center">
  ...
  />
    ...
    <div className="flex flex-col lg:flex-row items-center w-full h-full flex-1 justify-center items-center">
      {/* Left: Text */}
      <div className="flex-1 flex flex-col justify-center items-center lg:items-start text-white text-center lg:text-left mb-16 lg:mb-0 ">
        ...
        <p className="mb-8 text-base sm:text-lg md:text-xl font-secondary max-w-4xl ">
          NOW virker på både iPhone og Android og gør det nemt at registrere arbejdstid <br/> – uanset om du er på farten, ude på en opgave eller arbejder hjemmefra.
        </p>
